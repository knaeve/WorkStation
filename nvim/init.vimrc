...
Plug 'davidhalter/jedi-vim' " jedi
Plug 'glepnir/dashboard-nvim' " nice opening screen
...
Plug 'tpope/vim-speeddating' " a Ctrl-a/Ctrl-x command to increment / decrement a line of D:so ~/.vimrcate
